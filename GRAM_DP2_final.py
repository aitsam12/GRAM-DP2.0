...
class DifferentialPrivacyLibrary:
    ...
    def assess_dependence(self):
        ...
        data_relevance = int(input("On a scale of 5 to 1, how relevant is the dataset you are inserting to the overall functioning of your business? "))
        data_sensitivity = int(input("On a scale of 5 to 1, how sensitive is the information contained in the dataset? "))
        data_uniqueness = int(input("On a scale of 5 to 1, how unique or proprietary is the information in the dataset? "))
        data_volume = int(input("On a scale of 5 to 1, how large is the volume of data you are inserting into the system? "))
        data_source_trust = int(input("On a scale of 5 to 1, how much do you trust the source of the dataset you are inserting? "))
